...
def insert_user(fullname, phonenumber, password, email):
    ...
    conn.close()
import sqlite3
from PyQt5.QtWidgets import QMainWindow, QWidget, QLabel, QPushButton, QLineEdit, QMenuBar, QStatusBar, QMessageBox
...
class LoginWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.Upass.setEchoMode(QLineEdit.Password)  # Hide password input
    ...
    def checkLogin(self):
        ...
        if user==user:
            # Successful login, proceed to the next page or perform other actions
